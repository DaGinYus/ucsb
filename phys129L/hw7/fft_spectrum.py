...
#
# MODIFIED TO USE MY OWN DFT FUNCTION
...
# this takes forever with this many samples
print(f"Starting DFT on sequence of length {16*npts}")
ft = fourier.dft(y, n=16*npts)
ftnorm = abs(ft)
ps = ftnorm**2
